...
public class CustomRefreshFilter {
    ...
    public  void RefreshCheck(String authorizationHeader, userServiceUsa userService, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public  void RefreshUpdateToken(User user, HttpServletRequest request, HttpServletResponse response, userServiceUsa userService) throws Exception {
